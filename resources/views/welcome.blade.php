                                ...
                                <div class="xp-social-profile-img">
                                    <div class="row">
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/stik.jfif') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/stik2.jfif') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/stik3.jfif') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-3">
                                            <div class="xp-social-profile-avatar text-center">
                                                <img src="{{asset('foto/stik4.jfif') }}" alt="user-profile" class="rounded-circle img-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="xp-social-profile-title">
                                                <h5 class="my-1 text-black">akbarfidyantara</h5>
                                            </div>
                                            <div class="xp-social-profile-subtitle">
                                                <p class="mb-3 text-muted">AkbarFidyantara</p>
                                            </div>
                                            <div class="xp-social-profile-desc">
                                                <p class="text-muted">"Just Play," <br>Kelas 6C Nim 18090101</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
